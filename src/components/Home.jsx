...
const Home = () => {
    return (
        <div className='w-full py-[2rem] xl:h-[80vh] mx-auto'>
            <div className='grid grid-cols-[1fr_3fr_3fr] md:grid-cols-[1fr_7fr_7fr] xl:grid-cols-[2fr_7fr_7fr] gap-3 xl:gap-8 h-full items-center justify-center'>
                <div className='flex flex-col gap-7'>
                    <a href="" className='hover:text-red-400'><UilLinkedinAlt /></a>
                    <a href="" className='hover:text-red-400'><UilDribbble /></a>
                    <a href="" className='hover:text-red-400'><UilGithubAlt /></a>
                    <a href="" className='hover:text-red-400'><UilInstagram /></a>
                </div>


                <div className='md:px-8 xl:px-[4rem] flex flex-col justify-center col-span-2 md:col-span-1'>
                    <svg class="fill-red-500 my-[5rem]"
                        viewBox="0 0 200 187"
                    ...
                    <div className='animate-bounce flex justify-center items-center gap-4 cursor-pointer'>
                        <UilMouseAlt className='text-red-400' />
                        Scroll down
                        <UilArrowDown className='text-red-400' />
                    </div>
                </div>
                ...
                <div className='flex flex-col justify-center gap-6 col-span-3 py-8 md:py-0 md:col-span-1'>
                    ...
                    <div className='flex items-center gap-4'>
                        <hr className='h-[2px] border-red-400 bg-red-400 w-[10%]' />
                    ...
                    <div className='group flex gap-3 items-center justify-center button-custom w-[50%] md:w-[60%] xl:w-[35%] bg-red-500 hover:bg-red-600 text-white'>
                        Let's Talk
